...
<head>
    ...
    <title>{{ config('app.name', 'Only Fitness') }} | {{ $title ?? 'Dashboard' }}</title>
...
<body class="font-body bg-brand-dark antialiased"
    ...
    <aside class="fixed left-0 top-0 h-screen w-64 bg-brand-black border-r border-white/10 z-50
        ...
        <div class="py-6 px-6 flex items-center gap-3">
            ...
            <div>
                ...
                <span class="block text-gray-400 text-xs font-heading uppercase tracking-widest">Member</span>
            </div>
        </div>
        ...
        @php
            $memberNavs = [
                ...
                ['name' => 'My Bookings', 'route' => 'member.bookings', 'icon' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z'],
                ['name' => 'Progress', 'route' => 'member.progress', 'icon' => 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z'],
                ['name' => 'Profile', 'route' => 'member.profile', 'icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z'],
            ];
        @endphp
    ...
    <div class="lg:pl-64">
        ...
        <header class="bg-brand-black bg-opacity-50 border-b border-white/10 h-16 flex items-center justify-between px-6 lg:px-8">
            <h1 class="font-heading text-lg font-bold text-white uppercase tracking-wide">{{ $title ?? 'Dashboard' }}</h1>
